        ...
        <Link href="/home">
          {
            segment === 'home' ? <>
              ...
              <Strong styleProps={{weight: "bold"}}>홈</Strong>
            </> : <>
              <span>
                <svg width={26} viewBox="0 0 24 24" aria-hidden="true"
                  className="r-18jsvk2 r-4qtqp9 r-yyyyoo r-lwhw9o r-dnmrzs r-bnwqim r-1plcrui r-lrvibr r-cnnz9e">
        ...
        <Link href="/explore">
          {
            segment === 'explore' ? <>
              ...
              <Strong styleProps={{weight: "bold"}}>탐색하기</Strong>
            </> : <>
              <span>
                <svg width={26} viewBox="0 0 24 24" aria-hidden="true"
                  className="r-18jsvk2 r-4qtqp9 r-yyyyoo r-lwhw9o r-dnmrzs r-bnwqim r-1plcrui r-lrvibr r-cnnz9e">
        ...
        <Link href="/messages">
          {
            segment === 'messages' ? <>
              ...
              <Strong styleProps={{weight: "bold"}}>쪽지</Strong>
            </> : <>
              <span>
                <svg width={26} viewBox="0 0 24 24" aria-hidden="true"
                  className="r-18jsvk2 r-4qtqp9 r-yyyyoo r-lwhw9o r-dnmrzs r-bnwqim r-1plcrui r-lrvibr r-cnnz9e">
          ...
          <Link href={`/${me?.user?.email}`}>
            {
              segment === me?.user?.email ? <>
                ...
                <Strong styleProps={{weight: "bold"}}>프로필</Strong>
              </> : <>
                <span>
                  <svg width={26} viewBox="0 0 24 24" aria-hidden="true"
                    className="r-18jsvk2 r-4qtqp9 r-yyyyoo r-lwhw9o r-dnmrzs r-bnwqim r-1plcrui r-lrvibr r-cnnz9e">
