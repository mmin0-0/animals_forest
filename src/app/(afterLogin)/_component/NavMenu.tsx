    ...
    <>
      <style.NavItem>
        <Link href="/home">
          {
            segment === 'home' ? <>
              <Typography as="span" className="active">
              ...
              <Typography as="strong" styleProps={{ weight: "bold" }}>홈</Typography>
            </> : <>
              <Typography as="span">
                <svg width={26} viewBox="0 0 24 24" aria-hidden="true"
                  className="r-18jsvk2 r-4qtqp9 r-yyyyoo r-lwhw9o r-dnmrzs r-bnwqim r-1plcrui r-lrvibr r-cnnz9e">
              ...
              <Typography as="strong">홈</Typography>
            </>
          }
        </Link>
      </style.NavItem>
        ...
        <Link href="/explore">
          {
            segment === 'explore' ? <>
              ...
              <Typography as="strong" styleProps={{ weight: "bold" }}>탐색하기</Typography>
            </> : <>
              <Typography as="span">
                <svg width={26} viewBox="0 0 24 24" aria-hidden="true"
                  className="r-18jsvk2 r-4qtqp9 r-yyyyoo r-lwhw9o r-dnmrzs r-bnwqim r-1plcrui r-lrvibr r-cnnz9e">
              ...
              <Typography as="strong">탐색하기</Typography>
            </>
          }
        </Link>
      </style.NavItem>
        ...
        <Link href="/messages">
          {
            segment === 'messages' ? <>
              ...
              <Typography as="strong" styleProps={{ weight: "bold" }}>쪽지</Typography>
            </> : <>
              <Typography as="span">
                <svg width={26} viewBox="0 0 24 24" aria-hidden="true"
                  className="r-18jsvk2 r-4qtqp9 r-yyyyoo r-lwhw9o r-dnmrzs r-bnwqim r-1plcrui r-lrvibr r-cnnz9e">
              ...
              <Typography as="strong">쪽지</Typography>
            </>
          }
        </Link>
      </style.NavItem>
      {
        me?.user?.email && <style.NavItem>
          <Link href={`/${me?.user?.email}`}>
            {
              segment === me?.user?.email ? <>
                ...
                <Typography as="strong" styleProps={{ weight: "bold" }}>프로필</Typography>
              </> : <>
                <Typography as="span">
                  <svg width={26} viewBox="0 0 24 24" aria-hidden="true"
                    className="r-18jsvk2 r-4qtqp9 r-yyyyoo r-lwhw9o r-dnmrzs r-bnwqim r-1plcrui r-lrvibr r-cnnz9e">
                ...
                <Typography as="strong">프로필</Typography>
              </>
            }
          </Link>
        </style.NavItem>
